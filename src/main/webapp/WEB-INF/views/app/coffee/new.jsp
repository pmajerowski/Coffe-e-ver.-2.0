...
<html>
    ...
    <body>
        <header>
            <div class="navbar">
                <div class="navbar-left">
                    ...
                    <div>
                         <strong style="font-size: xx-large">Add coffee</strong>
                    </div>
                </div>
        ...
        <div class="center">
            <form:form method="post" action="/coffee/save" modelAttribute="coffee">
                ...
                <p>
                    <span>
                        <form:label path="processing">Processing</form:label>
                    </span>
                    <br>
                    <span class="list">
                ...
                <p>
                    ...
                    <br>
                    <span>
                        <form:checkboxes cssStyle="width: auto; align-items: flex-end" itemValue="id"
                                         itemLabel="name" path="brewTypes" items="${brewingTypesList}" multiple="true"/>
                    </span>
                    <br>
                ...
                <p>
                    <span>
                        <form:label path="flavourNotes">Flavour notes</form:label>
                    </span>
                    <br>
                    <span>
                ...
                <p>
                    <span>
                        <form:label path="quantity">Quantity (in grams)</form:label>
                    </span>
                    <br>
                    <span>
