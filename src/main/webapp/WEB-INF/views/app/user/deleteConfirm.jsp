...
<html>
    ...
    <body>
        <header>
            <div class="navbar">
                <div class="navbar-left">
                    ...
                    <div>
                        <strong style="font-size: xx-large">Delete account</strong>
                    </div>
                </div>
        ...
        <div style="padding-top: 100px">
            <h3 style="text-align: center">Are you sure you want to delete Your account?</h3>
            <h4 style="text-align: center">This is irreversible.</h4>
            <p style="text-align: center">
                <a  href="/user/delete/${id}" class="btn_2" >DELETE</a>
            </p>
            <p style="text-align: center">
                <a href="/dashboard" class="btn_2">CANCEL</a>
            </p>
        </div>
